  ...
  return (
    <>
      ...
      <section className=" max-w-7xl mx-auto w-full py-12 px-4">
        <div>
          <h1 className="text-4xl font-bold text-amber-950 mb-6">About Us</h1>
        ...
        <div className="flex justify-between items-center">
          <div className="w-[50%]">
            <h2 className="text-3xl font-semibold text-amber-950 mb-4">
              Our Story
            </h2>
            <p className="text-md text-amber-950 mb-6">
            ...
            <ul className="list-disc pl-5 text-md text-amber-950 mb-6">
              <li className="mb-2">
