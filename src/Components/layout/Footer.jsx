...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-black text-white py-12 relative mt-40">
      {/* Coupon Section */}
      <div className="absolute inset-x-0 top-[-80px] text-[#fefbf1] flex justify-center z-0">
        <div className="bg-[#E5C643] border border-black shadow-xl p-6  max-w-3xl w-full text-center relative z-10">
          <h3 className="text-2xl font-bold mb-2">Want to Start?</h3>
          <p className="text-lg mb-4">  Contact us TODAY <button
            onClick={goToContact}
            className="bg-[#fefbf1] text-black border-black border px-4 py-2 font-semibold hover:bg-[#fefbf1] transition-colors duration-300 mx-3 mt-3">Get Sarted</button></p>
