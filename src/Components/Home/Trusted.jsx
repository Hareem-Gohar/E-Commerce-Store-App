...
const Trusted = () => {
  const trustedData = [
    {
      icon: <FaThumbsUp size={50} className="text-white bg-sky-700 p-2 rounded-full" />,
      title: 'Quality Products',
      description: 'We provide only the highest quality products to our customers.',
    },
    {
      icon: <FaUsers size={50} className="text-white bg-sky-700 p-2 rounded-full" />,
      title: 'Happy Customers',
      description: 'Our customers are our top priority, and their satisfaction is our goal.',
    },
    {
      icon: <FaAward size={50} className="text-white bg-sky-700 p-2 rounded-full" />,
      title: 'Award-Winning',
      description: 'Recognized for our excellence and commitment to quality.',
    },
    {
      icon: <FaShieldAlt size={50} className="text-white bg-sky-700 p-2 rounded-full" />,
  ...
  return (
    <section className=" py-20">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-sky-700 mb-12">Why Choose Us</h2>
