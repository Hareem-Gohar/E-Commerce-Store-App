...
const Trusted = () => {
  const trustedData = [
    {
      icon: <FaThumbsUp size={50} className="text-[#fefbf1] bg-amber-900 p-2 rounded-full" />,
      title: 'Quality Products',
      description: 'We provide only the highest quality products to our customers.',
    },
    {
      icon: <FaUsers size={50} className="text-[#fefbf1] bg-amber-900 p-2 rounded-full" />,
      title: 'Happy Customers',
      description: 'Our customers are our top priority, and their satisfaction is our goal.',
    },
    {
      icon: <FaAward size={50} className="text-[#fefbf1] bg-amber-900 p-2 rounded-full" />,
      title: 'Award-Winning',
      description: 'Recognized for our excellence and commitment to quality.',
    },
    {
      icon: <FaShieldAlt size={50} className="text-[#fefbf1] bg-amber-900 p-2 rounded-full" />,
